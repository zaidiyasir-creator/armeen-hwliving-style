        ...
        <section id="top" className="relative min-h-screen flex items-end overflow-hidden" data-testid="hero-section">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 pb-24 md:pb-32 w-full">
                <div className="max-w-4xl">
                    ...
                    <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl leading-[0.95] tracking-[-0.02em] text-white" data-testid="hero-title">
                        <span className="block">{t(content.hero.title_a)}</span>
                        <span className="block italic text-[#E9B949]/90 font-light">{t(content.hero.title_b)}</span>
                    </h1>
